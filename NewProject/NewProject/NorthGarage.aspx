<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="NorthGarage.aspx.cs" Inherits="NewProject.GetDirections" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <script type="text/javascript">
        ...
        function calcRoute(pos1) {
            ...
            /*North Garage Coordinates*/
            var end = new google.maps.LatLng(37.338758,-121.880592);
            var request = {
                origin: start,
                destination: end,
