<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="WestGarage.aspx.cs" Inherits="NewProject.WebForm5" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <script type="text/javascript">
        ...
        function calcRoute(pos1) {
            ...
            /*lat and long of West Garragee*/
            var end = new google.maps.LatLng(37.332332, -121.883105);
            var request = {
                origin: start,
                destination: end,
